...
summon cat ~ ~ ~ {Palladium:{Properties:{superpowers:["decay:stands/double_dummy"]}},Tags:["new","tamed_cat","helpdupe"],Invisible:1b,Silent:1b,ActiveEffects:[{Id:14,Amplifier:5b,Duration:199999980,ShowParticles:0b}],DeathLootTable:"minecraft:empty"}
