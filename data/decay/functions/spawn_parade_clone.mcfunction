...
summon wolf ~ ~ ~ {Palladium:{Properties:{superpowers:["decay:sadmansparade_dummy"]}},Tags:["new","tamed_wolf"],Invisible:1b,Silent:1b,ActiveEffects:[{Id:14,Amplifier:5b,Duration:199999980,ShowParticles:0b}],DeathLootTable:"minecraft:empty"}
